...
class Main(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.save_path = ""
        self.big_code = pyqrcode.create('http://www.fanyanlindsay.com', error='L', version=10, mode='binary')
        self.big_code.png('code.png', scale=1, module_color=[0, 0, 0, 128], background=[0xff, 0xff, 0xcc])
        ...
        camera_toolbar.setIconSize(QSize(40, 40))
        ...
        self.setWindowTitle("Retail Sanitization")
        self.show()
